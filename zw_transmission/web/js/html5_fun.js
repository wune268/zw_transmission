...
(function(isSupportFileUpload){
	...
	//更换样式
		...
		$("#drag_area").addClass("wf_normal").html("<h3>拖拽至此上传</h3>")
	}
...
function handleDrop(evt){
	...
	addTable(evt.dataTransfer.files);
...
{
	addTable(document.getElementById('fileToUpload').files);
}

function addTable(objFileArray)
{
	console.log("Drop");
	isDragOver = false;
	var file={};
	var errorMsgs = [];
	var len = objFileArray.length;
