...
var fileTypes = "txt|epub|ebk2|ebk3|pdf|umd|doc|docx|wps|xls|xlsx|et|ppt|pptx|dps|png|jpeg|bmp|gif|jpg|JPG|";
if(document.title.match('WiFi 字体')){
	fileTypes = "ttf"
}
...
/*    var len = filesUpload.length;
    for(var i=0; i< len; i++){
        if(filesUpload[i].name == file.name)	{
            return "你的书架已经有一本《"+file.name+"》，请修改文件名后再上传";
        }
    }*/
    return null;
}

function checkFont(file) {
